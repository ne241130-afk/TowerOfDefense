...
/// </summary>
public class MeatEffectObject : MonoBehaviour, ITurnActor
{
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning("MeatEffectObject: FieldGridConfig が見つかりません。", this);
            return;
        }
    ...
    public void OnTurnTick()
    {
        ...
        if (animal.Stats.diet != AnimalDiet.Carnivore) return;
